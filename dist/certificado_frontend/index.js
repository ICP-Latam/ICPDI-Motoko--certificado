...
/***/ "./src/declarations/certificado_backend/certificado_backend.did.js":
/*!*************************************************************************!*\
  !*** ./src/declarations/certificado_backend/certificado_backend.did.js ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/declarations/certificado_backend/index.js":
/*!*******************************************************!*\
  !*** ./src/declarations/certificado_backend/index.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   certificado_backend: () => (/* binding */ certificado_backend),
/* harmony export */   createActor: () => (/* binding */ createActor),
/* harmony export */   idlFactory: () => (/* reexport safe */ _certificado_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory)
/* harmony export */ });
...
/* harmony import */ var _certificado_backend_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./certificado_backend.did.js */ "./src/declarations/certificado_backend/certificado_backend.did.js");
...
const createActor = (canisterId, options = {}) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_certificado_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
const certificado_backend = createActor(canisterId);
...
"use strict";
/*!***********************************************!*\
  !*** ./src/certificado_frontend/src/index.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_certificado_backend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/certificado_backend */ "./src/declarations/certificado_backend/index.js");
...
document.querySelector("form").addEventListener("submit", async (e) => {
  ...
  if (opcion=="CREAR") {
    const greeting = await _declarations_certificado_backend__WEBPACK_IMPORTED_MODULE_0__.certificado_backend.crearCertificado(curso, instructor, alumno, fecha, modalidad, lugar);
    //const numero=certificado_backend.getCertificaId();
    window.alert("Certificado creado");
  }else{
    if (opcion=="BORRAR"){
      const greeting = await _declarations_certificado_backend__WEBPACK_IMPORTED_MODULE_0__.certificado_backend.borraCertificado(id);
      if(greeting){
      ...
      if(opcion=="ACTUALIZAR"){
        const greeting = await _declarations_certificado_backend__WEBPACK_IMPORTED_MODULE_0__.certificado_backend.actualizaCertificado(id,curso,instructor,alumno, fecha, modalidad, lugar);
        if(greeting){
        ...
        if(opcion=='LEER'){
          var greeting = await _declarations_certificado_backend__WEBPACK_IMPORTED_MODULE_0__.certificado_backend.getCertificado(id);
          ...
          if(opcion=='ENLISTAR'){
            const greeting = await _declarations_certificado_backend__WEBPACK_IMPORTED_MODULE_0__.certificado_backend.getCertificados();
            if(greeting!=null){
